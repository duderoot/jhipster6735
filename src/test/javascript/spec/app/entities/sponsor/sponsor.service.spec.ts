...
describe('Service Tests', () => {
    describe('Sponsor Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(SponsorService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/sponsors';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Sponsor', () => {
                service.create(new Sponsor(null)).subscribe(received => {
            ...
            it('should update a Sponsor', () => {
                service.update(new Sponsor(123)).subscribe(received => {
