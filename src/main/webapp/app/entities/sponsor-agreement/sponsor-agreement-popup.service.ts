...
@Injectable()
export class SponsorAgreementPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.sponsorAgreementModalRef(component, new SponsorAgreement());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    sponsorAgreementModalRef(component: Component, sponsorAgreement: SponsorAgreement): NgbModalRef {
        const modalRef = this.modalService.open(component, { size: 'lg', backdrop: 'static'});
        modalRef.componentInstance.sponsorAgreement = sponsorAgreement;
